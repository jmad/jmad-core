...
public class SequenceDefinitionListFilter extends GenericCollectionFilter {
	public SequenceDefinitionListFilter(Mapper mapper) {
		super(mapper);
	}
	...
	protected Optional<Set<?>> filterSet(MarshallingContext context) {
		return Optional.ofNullable(context.get(ModelDefinitionMetaData.EXPORT_REQUEST)) //
				...
				.map(JMadModelDefinitionExportRequest::getSequencesToExport) //
