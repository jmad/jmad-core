...
class MadxScriptCreationContext {
     ...
     *
     * @param fileResolver    the function to resolve ModelFiles to (relative) paths
     * @param modelDefinition the {@link JMadModelDefinition} that will be saved
     * @param outputStream    the stream to write to
     */
    MadxScriptCreationContext(Function<ModelFile, String> fileResolver, JMadModelDefinition modelDefinition,
     ...
     *
     * @param madxCommand the command to write
     */
    ...
    public void call(ModelFile file) {
        command(new CallCommand(fileResolver.apply(file)));
    }
     ...
     * their active form.
     *
     * @param writeCommented whether to write commands/calls commented
     */
